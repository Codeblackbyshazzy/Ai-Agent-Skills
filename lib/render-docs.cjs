...
function buildLibraryStatsSection(data) {
  ...
  return [
    ...
    `  <a href="${npmUrl}"><img alt="npm downloads last month" src="${badgeBase}/npm/dm/ai-agent-skills?style=for-the-badge&label=downloads&labelColor=${labelBg}&color=${downloadsAccent}&logo=npm&logoColor=${lightText}" /></a>`,
